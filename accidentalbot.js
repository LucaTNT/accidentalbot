...
function getRequestAddress(request) {
    if (proxied && (typeof request.msg !== "undefined") && "headers" in request.msg && 'x-forwarded-for' in request.msg.headers) {
        ...
        var forwardedForAddresses = request.msg.headers['x-forwarded-for'].split(',');
...
socketServer.on('connection', function(socket, msg) {
